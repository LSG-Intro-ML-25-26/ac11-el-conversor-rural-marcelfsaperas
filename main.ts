...
let regrowth_time = 3000
let text_cooldown = 2000
let nombres_recursos = ["Wood", "Chickens", "Potatoes", "Goats", "Eggs", "Horses"]
let cantidades_recursos = [0, 0, 0, 0, 0, 0]
...
function abrir_tienda() {
    ...
    myMenu2.setFrame(img`
        ...
        ..bbbbbbbbbbbbbbbbbbbb..
    `)
    myMenu2.setDimensions(100, 80)
    myMenu2.setTitle("Shop")
    myMenu2.setPosition(80, 60)
    myMenu2.onButtonPressed(controller.A, function on_button_pressed_a(selection: any, selected_index: number) {
        
        let producto_seleccionado = opciones_tienda[selected_index]
        myMenu2.close()
        abrir_menu_cantidad(producto_seleccionado)
    })
    myMenu2.onButtonPressed(controller.B, function on_button_pressed_b(selection: any, selected_index: any) {
...
function abrir_menu_cantidad(producto2: string) {
    ...
    menu_cantidad.setTitle("Cantidad de " + producto2)
    menu_cantidad.setPosition(80, 60)
    menu_cantidad.onButtonPressed(controller.A, function on_button_pressed3(selection3: any, selected_index2: number) {
    ...
    menu_cantidad.onButtonPressed(controller.B, function on_button_pressed4(selection4: any, selected_index3: any) {
...
controller.menu.onEvent(ControllerButtonEvent.Pressed, function on_menu_pressed() {
    ...
    if (menu_open == false && !shop_open) {
        ...
        myMenu.onButtonPressed(controller.A, function on_button_pressed2(selection2: any, selectedIndex: any) {
